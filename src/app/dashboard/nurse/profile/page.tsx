          ...
          <div className="flex flex-col items-center gap-4 mb-8">
            <div className="relative">
              {previewUrl ? (
                ...
                <div className="w-28 h-28 rounded-full bg-green-200 flex items-center justify-center border-4 border-green-100">
                  <span className="text-green-700 font-bold text-4xl">{profile.name?.charAt(0) || '?'}</span>
                </div>
              )}
              <button
                onClick={() => fileInputRef.current?.click()}
                className="absolute bottom-0 right-0 bg-green-500 hover:bg-green-600 text-white rounded-full p-2 shadow-md transition-colors"
